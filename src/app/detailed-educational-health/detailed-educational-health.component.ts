...
@Component({
  selector: 'app-detailed-educational-health',
  templateUrl: './detailed-educational-health.component.html',
  styleUrls: ['./detailed-educational-health.component.scss']
})
export class DetailedEducationalHealthComponent {

  pageHeading: string = 'Education Health'
...
get diagnostic() { return JSON.stringify(this.userform.value); }
  ...
  barChartdata = {
    "chart": {
      "caption": "Educational Health - Yearly Report",
